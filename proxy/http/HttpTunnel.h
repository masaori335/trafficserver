...
// TODO: This is a workaround hack - check activity by ACTIVITY_COP
...
public:
  ...
  // Workaround hacks for TLS (partial) blind tunnel
  // CAVEAT: This is different from active flag
...
private:
  ...
  // Activity check for TLS (Partial Blind/Forward) Tunnel
  bool m_tls_tunnel_active                 = false;
  Event *m_tls_tunnel_activity_check_event = nullptr;
  ink_hrtime m_tls_tunnel_last_update      = 0;
